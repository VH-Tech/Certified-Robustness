...
#SBATCH --job-name cifar-Certified-Robustness.job
...
CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 0.25

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 1.0

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 0.25 --dataset_fraction 0.5 

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 1.0 --dataset_fraction 0.5

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 0.25 --dataset_fraction 0.1

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 1.0 --dataset_fraction 0.1

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 0.25 --dataset_fraction 0.01

CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset cifar10 --arch vit_custom --outdir /scratch/ravihm.scee.iitmandi/models/cifar10/vit_custom --batch 64 --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10 --workers 6 --tuning_method compacter --noise_sd 1.0 --dataset_fraction 0.01
