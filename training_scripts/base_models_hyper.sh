...
# CUDA_VISIBLE_DEVICES=0,1 accelerate launch train_classifier.py --dataset hyper --arch swin --outdir /scratch/ravihm.scee.iitmandi/models/hyper/swin --batch 16 --data_dir /scratch/ravihm.scee.iitmandi/dataset/hyper --lr 5e-4 --epochs 20
