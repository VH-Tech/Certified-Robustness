...
export OPENAI_LOGDIR="/scratch/ravihm.scee.iitmandi/models/cifar10/diffusion/1.0"

mpiexec -n 2 python scripts/image_train.py --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10_1.0 $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
