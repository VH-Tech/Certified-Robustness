...
#SBATCH --job-name 1e-3-Diffusion-Certified-Robustness.job
...
export OPENAI_LOGDIR="/scratch/ravihm.scee.iitmandi/models/cifar10/diffusion/0.001"

mpiexec -n 2 python scripts/image_train.py --data_dir /scratch/ravihm.scee.iitmandi/dataset/cifar10_0.001 $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
