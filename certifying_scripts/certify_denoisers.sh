...
python certify.py --dataset cifar10 --base_classifier vit --sigma 0.75 --outfile certify_denoiser_0.75.txt --denoiser /scratch/ravihm.scee.iitmandi/models/cifar10/vit/denoiser_1.0_0.75/checkpoint.pth.tar --N 10000 --batch 512 --skip 20
